    ...
    <Modal show={isDeleteModalOpen} onClose={() => setIsDeleteModalOpen(false)}>
      <div className="confirmation-modal">
        ...
        <div className="confirmation-modal-buttons">
          <button className="offer-confirm-button" onClick={handleDeleteConfirm}>
            Supprimer
          </button>
          <button className="offer-cancel-button" onClick={() => setIsDeleteModalOpen(false)}>
            Annuler
          </button>
        </div>
      </div>
    ...
    <>
      <div className="my-offer-containerrs">
        <div className="main1-content">
          <button className="add-offer-button" onClick={() => setIsModalOpen(true)}>
            Partager une nouvelle offre
          </button>
              ...
              <tbody>
                {offers.map((offer) => (
                  <tr key={offer._id}>
                    ...
                    <td>{offer.prix ? `${offer.prix} Dt` : 'N/A'}</td>
